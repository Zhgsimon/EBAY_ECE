	...
	<div class="row">
		<div class="paymentCont">
						<div class="headingWrap">
								<h3 class="headingTop text-center">Selectionez votre moyen de paiement</h3>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-md-4">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="cardNumber" placeholder="NUM CARD"
                                required  />
                    ...
                    <div class="row">
                    <h5 class="text-center"> <b>Sommes du paiement : XXXX<b><span class="glyphicon glyphicon-euro"></span></h5>
                	</div>
            ...
            <br/>
            <input type="submit" name="" class="btn-black btn-lg btn-block" role="button" value="Payer"></b>
        </div>
    </div>
</div>
