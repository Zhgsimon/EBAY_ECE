            ...
            <div class="login-form">
              ...
              <div class="col-sm-6">
                ...
                <div class="form">
                  ...
                  <input type="file" name="img_item" accept="image/png, image/jpeg, image/jpg" required style="margin-bottom: 30px; margin-top: 5px">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="Nom item" required name="Nom_item">
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <input type="radio" name="Catégorie" ><label style="margin-right: 35px; margin-top: 10px">Féraille et trésor</label>
                      <input type="radio" name="Catégorie" ><label style="margin-right: 35px">Bon pour le musée</label>
                      <input type="radio" name="Catégorie" ><label>VIP</label>
                  ...
                  <div class="form-group">
                     <label>Prix Immédiat(en €)</label>
                     <input type="number" class="form-control" required name="Prix">
                  </div>


                  <div><input  type="radio" name="type vente" id="1"><label style="margin-right: 35px" >Proposer aux enchère(en €)</label>

                  <input type="radio" name="type vente" id="4"><label>Proposer de négocier</label></div>



                  <div class="form-group">
                     <label id="1" style="display: none;">Prix initial</label>
                     <input type="number" class="form-control"  required name="Prix 2" style="display: none;" id="2">
                  </div>
